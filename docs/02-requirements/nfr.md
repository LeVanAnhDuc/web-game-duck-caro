...
| NFR-PERF-08 | First Load JS ≤ **150 kB**. Đo 2026-09-04 sau mốc 4: **114 kB** | `next build` rồi đọc cột First Load JS |
...
NFR-PERF-08 đã có số thật từ `next build` (114 kB), và ngưỡng 150 kB được chọn
