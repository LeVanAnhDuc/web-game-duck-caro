...
| [`02-requirements/nfr.md`](02-requirements/nfr.md) | Ngưỡng nào áp cho **mọi** feature, để không phải nhắc lại … | 🟢 đủ — mọi ngưỡng đã có số đo, trừ NFR-PERF… | thêm loại tài nguyên mới · thêm nhóm người dùng · sau sự c… |
...
| [`decisions/`](decisions/README.md) | Tại sao lại làm thế này? | 22 ADR | mỗi quyết định kỹ thuật |
